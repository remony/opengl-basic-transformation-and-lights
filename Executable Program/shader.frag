...
void main()
{
	...
	fog.max_distance = 30; // the max fog distance
	fog.min_distance = 3; // The minimal fog distance
	fog.colour = vec4(0.3,0.3,0.3, 1.0); // The fog colour, usually will want this white or grey 
	...
	if(degrees(acos(dot(-distanceToLight, normalize(0.0)))) > 20f){
    attenuation = 0.0;
	} 
