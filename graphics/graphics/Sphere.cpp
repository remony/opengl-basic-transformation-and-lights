...
void Sphere::drawSphere(GLuint drawmode)
{
	GLuint i;
...
GLuint Sphere::makeSphereVBO(GLuint numlat, GLuint numlong)
{
	GLuint i, j;
...
// Define south pole
pVertices[vnum * 3] = 0; pVertices[vnum * 3 + 1] = 0; pVertices[vnum * 3 + 2] = 0.f;
}
